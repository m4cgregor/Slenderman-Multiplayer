...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : NetworkBehaviour  // Cambiamos el Monobehaviour por NertworkBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Si no es el local player, salimos (para que no se muevan todos )
